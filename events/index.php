        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-10 animate__animated animate__fadeIn">
                <div class="d-inline-flex align-items-center mb-4 px-4 py-2 rounded-pill shadow-sm hero-badge">
                    <small class="fw-bold text-gradient text-uppercase ls-2">Connect &bull; Learn &bull; Grow</small>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 fade-up-trigger">
                        <div class="event-card-modern h-100">
                            ...
                            <div class="event-card-body p-4">
                                ...
                                <a href="https://www.meetup.com/mumbai-women-coders/" target="_blank" class="btn btn-outline-primary rounded-pill w-100 fw-bold">Register Now</a>
                            </div>
                        </div>
                    </div>
                     <!-- Event 2 -->
                     <div class="col-lg-4 col-md-6 fade-up-trigger" style="animation-delay: 0.1s;">
                        <div class="event-card-modern h-100">
                            ...
                            <div class="event-card-body p-4">
                                ...
                                <a href="https://www.meetup.com/mumbai-women-coders/" target="_blank" class="btn btn-outline-primary rounded-pill w-100 fw-bold">Join Waitlist</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container py-5">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 fade-up-trigger">
                <div class="chapter-card-fancy" style="background-image: url('https://images.unsplash.com/photo-1566552881560-0be862a7c445?auto=format&fit=crop&q=80&w=800');">
                    ...
                    <div class="chapter-content">
                        ...
                        <a href="../chapters/" class="btn btn-sm btn-light rounded-pill fw-bold px-4">View Events</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 fade-up-trigger" style="animation-delay: 0.4s;">
                <div class="chapter-card-fancy" style="background-image: url('https://images.unsplash.com/photo-1560969184-10fe8719e654?auto=format&fit=crop&q=80&w=800');">
                    <div class="chapter-overlay"></div>
                    <div class="chapter-content">
    ...
    <div class="container py-5">
        <div class="row align-items-center mb-5">
            ...
            <div class="col-lg-4 text-lg-end fade-up-trigger">
                <a href="#gallery" class="btn btn-outline-light rounded-pill px-4">View Archive</a>
            </div>
        </div>
