        ...
        <div class="row gy-5">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="footer-brand-fancy mb-4">
                    <img src="<?php echo $root ?? ''; ?>assets/images/logo.png" alt="MWC Logo" class="footer-logo-main mb-3">
                    <h3 class="fw-bold text-white mb-2">Mumbai Women <span class="text-gradient-lavender">Coders</span></h3>
                    <div class="brand-line"></div>
                </div>
                <p class="footer-bio mb-4 opacity-75">
                    Building Mumbai's most powerful ecosystem for women in tech. Join our community of 2500+ members to learn, lead, and innovate.
                </p>
                <div class="footer-social-cluster">
                    <a href="https://x.com/WomenCoders01" target="_blank" class="social-badge"><i class="bi bi-twitter-x"></i></a>
                    <a href="https://www.linkedin.com/company/mumbai-women-coders/" target="_blank" class="social-badge"><i class="bi bi-linkedin"></i></a>
                    <a href="https://www.instagram.com/mumbaiwomencoders/" target="_blank" class="social-badge"><i class="bi bi-instagram"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-12 text-center text-md-start">
                ...
                <div class="contact-strip mb-4 d-flex flex-column align-items-center align-items-md-start">
                    <div class="contact-item d-flex align-items-center mb-3 w-100 justify-content-center justify-content-md-start">
                        <div class="contact-icon"><i class="bi bi-geo-alt"></i></div>
                        <span class="small opacity-75">Mumbai, Maharashtra, India</span>
                    </div>
                    <div class="contact-item d-flex align-items-center w-100 justify-content-center justify-content-md-start">
        ...
        <div class="footer-bottom-fancy mt-5 pt-4">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <p class="mb-0 small opacity-50">&copy; <?php echo date('Y'); ?> Mumbai Women Coders. Engineered with <i class="bi bi-lightning-fill text-warning"></i> by the community.</p>
                </div>
