...
<section class="hero-section text-center hero-fixed-bg"
    style="background: linear-gradient(rgba(15, 5, 41, 0.85), rgba(15, 5, 41, 0.95)), url('../assets/images/chapters/backgrounds/london.webp');">
    <div class="container position-relative z-3">
        <div class="animate__animated animate__fadeInDown">
            ...
            <span class="badge bg-warning text-dark px-3 py-2 mb-4">
                <small class="text-uppercase fw-bold ls-1">Launching Soon in London 🇬🇧</small>
            </span>
...
<section id="notify" class="bg-chapter-cosmic py-5 position-relative overflow-hidden">
    ...
    <div class="container py-4 text-center">
        <div class="cta-box-refined animate-fade-up">
            <h2 class="display-5 fw-bold mb-4">London Waitlist</h2>
            <p class="lead text-muted mb-5">Be part of the founding community in London. We'll reach out when we're
