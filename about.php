        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-10 animate__animated animate__fadeIn">
                ...
                <div class="d-flex gap-3 justify-content-center">
                    <a href="#story" class="btn btn-premium btn-lg shadow-lg">Learn More <i class="bi bi-arrow-down ms-2"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 mb-5 mb-lg-0 fade-up-trigger">
                <div class="position-relative p-2">
                    ...
                    <div class="position-relative">
                        <div class="position-absolute bg-lavender rounded-4 opacity-10" style="inset: -15px 15px 15px -15px; z-index: -1;"></div>
                        <div class="img-premium-container shadow-2xl border-0 rounded-4 overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?auto=format&fit=crop&q=80&w=1200" class="d-block w-100" alt="Story of MWC" style="height: 480px; object-fit: cover;">
                        </div>
                        <div class="position-absolute bottom-0 start-0 m-3 p-3 bg-white rounded-3 shadow-sm d-flex align-items-center gap-2 border-start border-4 border-royal-violet">
            ...
            <div class="col-lg-6 ps-lg-5 fade-up-trigger">
                ...
                <div class="story-content">
                    <p class="mb-3 fs-5 about-desc">
                        Mumbai Women Coders was born from a simple observation: the tech industry in Mumbai needed a dedicated space for female talent to thrive.
                    </p>
                    <p class="mb-4 text-muted">
                        We started as a small group of engineers who wanted to share knowledge without barriers. Today, we are Mumbai's most active community for women in technology, providing the mentorship and visibility needed to reach leadership roles.
                    </p>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6 fade-up-trigger">
                <div class="glass-card-premium p-5 d-flex flex-column justify-content-center h-100">
                    ...
                    <p class="text-muted fs-5 mb-4">
                        "To create a world where women are equally represented in technical leadership positions, driving innovation and shaping the digital future."
                    </p>
                    <div class="mt-auto">
            ...
            <div class="col-lg-6">
                <div class="row g-4 h-100">
                    <div class="col-md-6 fade-up-trigger" style="animation-delay: 0.1s;">
                    ...
                    <div class="col-md-6 fade-up-trigger" style="animation-delay: 0.2s;">
                        <div class="glass-card-premium p-4 text-center">
                            <div class="icon-box-glow mx-auto">
                    ...
                    <div class="col-md-6 fade-up-trigger" style="animation-delay: 0.3s;">
                        <div class="glass-card-premium p-4 text-center">
                            <div class="icon-box-glow mx-auto">
                    ...
                    <div class="col-md-6 fade-up-trigger" style="animation-delay: 0.4s;">
                        <div class="glass-card-premium p-4 text-center">
                            <div class="icon-box-glow mx-auto">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-4 fade-up-trigger">
                <div class="m-card h-100 p-4 border-0 shadow-sm hover-shadow-lg transition-all" style="background: #fbf9ff;">
                    <div class="pillar-icon-box mb-4">
                        <i class="bi bi-heart-pulse"></i>
                    </div>
                    <h4 class="fw-bold mb-3">Radical Inclusion</h4>
                    <p class="text-muted small">We welcome all women who code, regardless of background, seniority, or education. Inclusion is our default state.</p>
                </div>
            </div>
            <div class="col-lg-4 fade-up-trigger">
                <div class="m-card h-100 p-4 border-0 shadow-sm hover-shadow-lg transition-all" style="background: #fbf9ff;">
                    ...
                    <p class="text-muted small">We don't just talk about tech; we build it. Our culture is defined by hands-on creation and constant review.</p>
                </div>
            </div>
            <div class="col-lg-4 fade-up-trigger">
                <div class="m-card h-100 p-4 border-0 shadow-sm hover-shadow-lg transition-all" style="background: #fbf9ff;">
                    ...
                    <p class="text-muted small">We foster a community where asking questions is encouraged and "failing forward" is the standard.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid px-lg-5">
        <div class="row g-0 rounded-4 overflow-hidden shadow-2xl border border-white border-opacity-25">
             ...
             <div class="col-lg-6 d-none d-lg-block position-relative">
                <img src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=1200" class="w-100 h-100 object-fit-cover" alt="Community Interaction">
                <div class="position-absolute inset-0 bg-dark-amethyst opacity-50"></div>
                <div class="position-absolute bottom-0 start-0 p-5">
                    <div class="glass-morphism p-4 rounded-4 border border-white border-opacity-20 text-white backdrop-blur">
            ...
            <div class="col-lg-6 p-5 p-md-5 d-flex flex-column justify-content-center">
                ...
                <p class="text-white-50 fs-5 mb-5 opacity-75">
                    We believe real change happens when everyone is part of the conversation. Our doors are open to those who support our mission.
                </p>
                
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="p-3 bg-white bg-opacity-10 rounded-4 border border-white border-opacity-10 h-100 hover-opacity-100 transition-all">
                            <h5 class="text-white fw-bold mb-3 d-flex align-items-center gap-2">
                                <i class="bi bi-person-fill text-mauve"></i> Women
                            </h5>
                            <p class="text-white-50 small mb-0">Access exclusive mentorship, leadership tracks, and a safe learning environment.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="p-3 bg-white bg-opacity-10 rounded-4 border border-white border-opacity-10 h-100 hover-opacity-100 transition-all">
                            ...
                            <p class="text-white-50 small mb-0">Attend open meetups, share technical expertise, and advocate for gender equity.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cta-box-refined cta-box-gradient shadow-lg border-0 fade-up-trigger">
            <div class="position-relative z-2">
                ...
                <div class="d-inline-flex gap-3 justify-content-center align-items-center flex-column flex-sm-row">
                    <a href="https://www.meetup.com/mumbai-women-coders/" target="_blank" class="btn btn-white-filled btn-lg px-5">Join our Meetup</a>
